...
// const {data: paymentMethodData, isLoading: taxLoad} = useQuery('taxes',() => fetchSingleTax(parms['id']))
...
//   const [activeTab, setActiveTab] = useState('tab1');
  ...
  let paymentMethodData : any = location?.state
...
//   console.log('paymentMethodData: ',paymentMethodData?.data[0].id);
        ...
        <div className="tab-content">
          ...
          {<div className='col-8'>
            ...
            <div className='row mb-0'>
              ...
              <input type="text"  {...register("name")} disabled={false} defaultValue={paymentMethodData.name}  className="form-control form-control-solid" />
              </div>
              <div className='col-6 mb-7'>
              <label htmlFor="exampleFormControlInput1" className="required form-label">Tin Number</label>
              <input type="text"  {...register("tinNumber")} disabled={false} defaultValue={paymentMethodData.tinNumber}  className="form-control form-control-solid" />
              </div>
            </div>
            <div className='row mb-0'>
              <div className='col-6 mb-7'>
              <label htmlFor="exampleFormControlInput1" className="required form-label">Description</label>
              <input type="text"  {...register("description")} disabled={false} defaultValue={paymentMethodData.description}  className="form-control form-control-solid" />
              </div>
              <div className='col-6 mb-7'>
              <label htmlFor="exampleFormControlInput1" className="required form-label">Phone Number</label>
              <input type="text"  {...register("phoneNumber")} disabled={false} defaultValue={paymentMethodData.phoneNumber}  className="form-control form-control-solid" />
              </div>
            </div>
          </div>
          }
