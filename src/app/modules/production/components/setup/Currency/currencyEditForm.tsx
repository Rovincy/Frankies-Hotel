...
// const {data: currencyData, isLoading: taxLoad} = useQuery('taxes',() => fetchSingleTax(parms['id']))
...
//   const [activeTab, setActiveTab] = useState('tab1');
  ...
  let currencyData : any = location?.state
...
//   console.log('currencyData: ',currencyData?.data[0].id);
        ...
        <div className="tab-content">
          ...
          {<div className='col-8'>
            ...
            <div className='row mb-0'>
              ...
              <input type="text"  {...register("name")} disabled={false} defaultValue={currencyData.name}  className="form-control form-control-solid" />
              </div>
              <div className='col-6 mb-7'>
              <label htmlFor="exampleFormControlInput1" className="required form-label">Rate</label>
              <input type="number"  {...register("rate")} disabled={false} defaultValue={currencyData.rate}  className="form-control form-control-solid" />
              </div>
              <div className='col-6 mb-7'>
              <label htmlFor="exampleFormControlInput1" className="required form-label">Rate</label>
