...
import {Api_Endpoint, fetchCurrencies, fetchRooms} from '../../../../../services/ApiCalls'
...
const Currency = () => {
  ...
  const {data: currencydata, isLoading: roomsLoad} = useQuery('currency', fetchCurrencies)
  ...
  const deleteData = async (element: any) => {
      ...
      onOk: async () => {
          const response = await axios.delete(`${BASE_URL}/Currency/id?id=`+element)
      ...
      if (response.status==200) {
        ...
        message.success("Currency deletion failed")
      }
